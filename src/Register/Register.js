        ...
        <>
            {success ? (
                ...
                <section>
                    ...
                    <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white-900 md:text-5xl lg:text-6xl dark:text-white">Register</h1>
                    ...
                    <p style={{ fontSize: '18px' }}>
                        ...
                        <span className="line">
                            ...
                            <a href="#" style={{color: 'rgb(250,250,60)'}}>Sign In</a>
                        </span>
                    </p>
                </section>
            )}
