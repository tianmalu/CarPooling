...
const CTA = ({darkMode}) => {
  return (
    <section className={`${darkMode ? 'bg-gray-900' : "bg-white"}`}>
      <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div className="mt-4 md:mt-0">
            <h2 className={`mb-4 text-4xl tracking-tight font-extrabold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Let's share our cars and save more energy together.</h2>
          <p className={`mb-6 font-light md:text-lg ${darkMode ? 'text-gray-400' : " text-gray-500 "}`}>Flowbite helps you connect with friends and communities of people who share your interests. Connecting with your friends and family as well as discovering new ones is easy with features like Groups.</p>
