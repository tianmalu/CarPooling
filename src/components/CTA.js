      ...
      <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div className="mt-4 md:mt-0">
            <h2 className={`mb-4 text-4xl tracking-tight font-extrabold ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              Let's share our cars and save more energy together.
            </h2>
          <p className={`mb-6 font-light md:text-lg ${darkMode ? 'text-gray-400' : " text-gray-500 "}`}>
            RideLink helps you connect with colleagues who want to share their car ride or want to take a shared car ride. Connecting with your colleagues as well as contributing to save energy for our planet.
          </p>
